 ...
 */
class Part extends \Entities\Part implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Part' . "\0" . 'id', '' . "\0" . 'Entities\\Part' . "\0" . 'name', '' . "\0" . 'Entities\\Part' . "\0" . 'price', 'car');
        }
    ...
    public function formattedPrice()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'formattedPrice', array());

        return parent::formattedPrice();
    }
