 ...
 */
class Passenger extends \Entities\Passenger implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Passenger' . "\0" . 'id', '' . "\0" . 'Entities\\Passenger' . "\0" . 'first_name', '' . "\0" . 'Entities\\Passenger' . "\0" . 'last_name', '' . "\0" . 'Entities\\Passenger' . "\0" . 'bio', 'car');
        }
